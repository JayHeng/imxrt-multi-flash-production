                      ...
                      uint32_t dsiHsBitClkFreq_Hz)
{
    ...
    float coff = (numLanes * (float)dsiHsBitClkFreq_Hz) / ((float)dpiPixelClkFreq_Hz * 8U);
    ...
    base->CFG_DPI_HFP                   = (uint32_t)((float)config->hfp * coff - DSI_HFP_OVERHEAD_BYTE);
    base->CFG_DPI_HBP                   = (uint32_t)((float)config->hbp * coff - DSI_HBP_OVERHEAD_BYTE);
    base->CFG_DPI_HSA                   = (uint32_t)((float)config->hsw * coff - DSI_HSA_OVERHEAD_BYTE);
